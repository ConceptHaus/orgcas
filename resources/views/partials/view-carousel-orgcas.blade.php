<style type="text/css">
    ...
    <section class="the-orgcas">
        <div class="container-lg">
            ...
            <div id="carouselTheOrgcas" class="justify-content-center pt-5">
                <div id="demo" class="carousel slide" data-bs-ride="true">
                  ...
                  <div class="carousel-inner  d-flex justify-content-center">
                    <div class="card-item mb-4 carousel-item active">
                        <div class="card p-4 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Porfiria.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Elena.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-4 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Gabriela.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Sofia-Martinez.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Frida-Lara.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Mariana-Velez.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Martina-Cocquio.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Sofia-Salinas.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Lizandra-Amezcua.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
                    ...
                    <div class="card-item mb-4 carousel-item">
                        <div class="card p-5 mb-4">
                            <div class="text-center">
                                <img src="{{ URL::to('/') }}/images/orgcas/Maru-Brito.png" alt="" style="border-radius: 50%;max-width: 137px;max-height: 137px;">
                                <div class="ms-2 c-details">
...
Le gusta estar con gente que la motiva, intenta ver el lado positivo de las situaciones. Alexa siente una conexión especial con las ballenas jorobadas, especialmente cuando están con sus crías.
