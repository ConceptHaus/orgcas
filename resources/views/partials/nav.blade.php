        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse mt-4" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ Route::current()->getName() ==  'quienes-somos' ? 'active' : ''  }}" href="{{route('quienes-somos')}}"> @if(Route::current()->getName() == 'quienes-somos') <span class="dot">.</span> @endif Quienes somos</a>
                    </li>
                    <li class="nav-item">
